...
public class TaskModule extends BasicModule<Task> {
	...
	private String getReportHtml(Task task, List<Report> reports) {
		...
		html.append("<table class=\"task\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"1px\">");
		...
		html.append("<td>").append(task.getStat()).append("</td>");
		...
		html.append("<td colspan=\"8\">&nbsp;</td>");
		html.append("</tr>");
		html.append("</table>");
		html.append("<textarea id=\"detail\" width=\"100%\"></textarea>");
		html.append("<hr>");
		if (reports.size() != 0) {
			...
			for (Report re : reports) {
				...
				html.append("</tr>");
				html.append("<tr>");
				html.append("<td colspan=\"6\">").append(re.getMsg()).append("</td>");
				html.append("</tr>");
				html.append("</table>");
				html.append("<br>");
			}
		}
		html.append("<div id=\"detail_hid\" style=\"display: none;\">")
